            ...
            <div class="panel panel-default">
                <div class="panel-body">
                            ...
                            <div class="col-md-10">
                                <div class="media">
                                    <div class="media-body">
                                        <h4 class="media-heading"><strong>${detailPost.username}</strong></h4>
                    ...
                    <section class="post-body">
                        <form method="post" action="/blogs?action=edit">
                            <fieldset>
                                <legend>Edit post</legend>
                                <div class='form-group'>
                                    <input required class='form-control' placeholder='Enter title' type='text' name="title" value="${detailPost.title}">
                                </div>
                                <div class='form-group'>
                                    <textarea required class='form-control' rows='4' name="content" >${detailPost.content}</textarea>
                                </div>
                                <c:if test="${detailPost.image != null}">
                                    <img src="${detailPost.image}" alt="..." width="100%" height="auto">
                                    <input type="text" name="image" value="${detailPost.image}" hidden>
                                    <input type="text" name="username" value="${detailPost.username}" hidden>
                                    <input type="text" name="time_post" value="${detailPost.date}" hidden>
