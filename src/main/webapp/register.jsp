    ...
    <div class="wrapper wrapper--w680">
        <div class="card card-4">
            <div class="card-body">
                ...
                <form method="POST" action="/blogs?action=register">
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                <div class="input-group-icon">
                                    <input class="input--style-4 " type="text" name="dob" placeholder="yyyy-mm-dd">
                    ...
                    <div class="row row-space">
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="text" name="phoneNumber" placeholder="Phone Number">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-t-15">
                        ...
                        <a class="txt2 text-center p-t-136" href="blogs" >
                            Back to Login
